...
import { PayOrderDataType, TableDataType, TableListQueryParams } from './data.d';
import {
    queryList,
    removeData,
    createData,
...
const StoreModel: ModuleType = {
    ...
    async createTableData({ commit }, payload: Pick<PayOrderDataType,  "id" |  "title" |  "description" |  "payType" |  "payWay" |  "payAmt" |  "discountAmt" |  "redpackmal" |  "expiredTime"> ) {
        try {
    ...
    async updateTableData({ commit }, payload: PayOrderDataType ) {
            try {
                const { id } = payload;
