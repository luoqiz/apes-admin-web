...
const StoreModel: ModuleType = {
    ...
    async createTableData({ commit }, payload: Pick<SysMenuDataType,  "type" | "title" 
    | "component" | "hidden" | "icon" | "path" | "name" | "createBy" | "updateBy" | "createTime" | "updateTime" | "pid" | "subCount" | "menuSort" | "iFrame" | "cache" | "permission"> ) {
        try {
