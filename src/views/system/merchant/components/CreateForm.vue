<template>
    ...
    >
        ...
        <a-form :labelCol="{ span: 4 }" :wrapper-col="{span:20}">
            ...
            <a-form-item label="支付类型" extra="详情查看com.egzosn.pay.spring.boot.core.merchant.PaymentPlatform对应子类，aliPay 支付宝， wxPay微信..等等" v-bind="validateInfos.payType">
            ...
            <a-form-item label="证书类型" extra="当前面私钥公钥为证书类型的时候，这里必填，可选值:PATH,STR,INPUT_STREAM" v-bind="validateInfos.certStoreType">
            ...
            <a-form-item label="签名方式" extra="签名方式,目前已实现多种签名方式详情查看com.egzosn.pay.common.util.sign.encrypt。MD5,RSA等等" v-bind="validateInfos.signType">
