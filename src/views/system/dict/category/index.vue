                ...
                <template #action="{ record }">
                    <a-row type="flex" justify="center">
                        <a-col flex="1" offset=2>
                            <a-button type="primary" size="small" @click.stop="() => detailUpdateData(record.dictId)" :loading="detailUpdateLoading.includes(record.dictId)">编辑</a-button>
                        </a-col>
                        <a-col flex="1" offset=2>
                            <a-button type="danger" size="small" @click.stop="() => deleteTableData(record.dictId)" :loading="deleteLoading.includes(record.dictId)">删除</a-button>
                        </a-col>
                    </a-row>
                </template>
            </a-table>
